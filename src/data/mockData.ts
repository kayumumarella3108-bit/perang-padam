...
export const INITIAL_KONSTRUKSI_GIS: KonstruksiGisItem[] = [
  {
    id: 'kst-001',
    namaProyek: 'Rekonstruksi Tiang Miring & Perkuatan Pondasi Ambles',
    nomorSpk: 'SPK/KONST/2026/014',
    penyulang: 'PASSO',
    section: 'GI Passo - LBS Transit',
    lokasi: 'Jl. Raya Passo Baguala (Depan SPBU Passo)',
    lat: -3.6260,
    lng: 128.2380,
    kategoriKonstruksi: 'Rekonstruksi Tiang Miring / Keropos',
    statusProyek: 'Sedang Dikerjakan',
    progresPersen: 65,
    targetSelesai: '2026-02-28',
    tglMulai: '2026-02-01',
    anggaranRp: 45000000,
    pelaksanaVendor: 'PT Maluku Daya Mandiri',
    pengawasPln: 'Samsul Bahri (Supervisor Teknik)',
    volumeAset: '4 Tiang Beton 12m / 350daN + 2 Set Guy Wire Guying',
    keterangan: 'Pondasi tiang lama ambles akibat erosi saluran air drainase. Tiang baru sudah berdiri, proses pemindahan traverse dan isolator.',
    coordinatesPolyline: [
      [-3.6250, 128.2360],
      [-3.6260, 128.2380],
      [-3.6270, 128.2400]
  ...
  {
    id: 'kst-002',
    namaProyek: 'Uprating Konduktor A3C 70 ke AAAC-S 150 mm2 (2.4 kms)',
    nomorSpk: 'SPK/UPR/2026/008',
    penyulang: 'TULEHU',
    section: 'GI Passo - Recloser Tulehu',
    lokasi: 'Jalur Utama Tulehu - Simpang Liang',
    lat: -3.5650,
    lng: 128.3420,
    kategoriKonstruksi: 'Uprating / Penggantian Konduktor',
    statusProyek: 'Sedang Dikerjakan',
    progresPersen: 40,
    targetSelesai: '2026-03-15',
    tglMulai: '2026-02-05',
    anggaranRp: 185000000,
    pelaksanaVendor: 'PT Citra Karya Elektrik',
    pengawasPln: 'Ahmad Rivai (Team Leader Yantek)',
    volumeAset: '2.400 meter Kawat AAAC-S 150 mm2 + 18 Set Cross-Arm UNP 10',
    keterangan: 'Peningkatan kapasitas hantar arus dan pengurangan losses tegangan ujung feeder Tulehu.',
    coordinatesPolyline: [
      [-3.5700, 128.3400],
      [-3.5650, 128.3420],
      [-3.5580, 128.3450]
  ...
  {
    id: 'kst-003',
    namaProyek: 'Pemasangan LBS Motorized Scada Ready Baru',
    nomorSpk: 'SPK/SWT/2026/003',
    penyulang: 'LATERI 2',
    section: 'GI Passo - IC Lateri 2 GH HATIVE',
    lokasi: 'Simpang Tiga Lateri - Hative Kecil (Tiang LTR2-60)',
    lat: -3.6450,
    lng: 128.2480,
    kategoriKonstruksi: 'Pemasangan LBS Motorized / Recloser',
    statusProyek: 'Uji Komisioning',
    progresPersen: 90,
    targetSelesai: '2026-02-20',
    tglMulai: '2026-01-25',
    anggaranRp: 120000000,
    pelaksanaVendor: 'PT Swadaya Prima Mandiri',
    pengawasPln: 'La Ode Darmin (Officer K3 & Inspeksi)',
    volumeAset: '1 Unit Gas Insulated LBS 24kV 630A + RTU SCADA Modbus Cellular',
    keterangan: 'Fisik LBS sudah terpasang, sedang tahap integrasi sinyal telecontrol dan telesignaling ke Dispatcher APD Maluku.'
  },
  {
    id: 'kst-004',
    namaProyek: 'Pembangunan Gardu Trafo Sisipan 160 kVA (GD-WH-08)',
    nomorSpk: 'SPK/GTT/2026/021',
    penyulang: 'WAIHERU 2',
    section: 'GI Passo - PMFD Air Besar Passo',
    lokasi: 'Perumahan Waiheru Asri Blok C',
    lat: -3.6140,
    lng: 128.2390,
    kategoriKonstruksi: 'Pembangunan GTT Sisipan',
    statusProyek: 'Selesai Beroperasi',
    progresPersen: 100,
    targetSelesai: '2026-02-10',
    tglMulai: '2026-01-15',
    anggaranRp: 95000000,
    pelaksanaVendor: 'CV Baguala Energi Perkasa',
    pengawasPln: 'Markus Pattipeilohy (Teknik 20kV)',
    volumeAset: '1 Unit Trafo Distribusi 160 kVA 20kV/400V + PHB-TR 4 Jurusan + 2 Tiang GTT Beton 12m',
    keterangan: 'Gardu sisipan telah energized dan berhasil mengatasi masalah drop tegangan pelanggan perumahan Waiheru.'
  },
  {
    id: 'kst-005',
    namaProyek: 'Pembangunan Perluasan JTM 20kV Baru (1.8 kms)',
    nomorSpk: 'SPK/JTM/2026/005',
    penyulang: 'LATERI 1',
    section: 'LBS Transit - LBS Natsepa',
    lokasi: 'Kawasan Pengembangan Wisata Pantai Natsepa - Suli Timur',
    lat: -3.6080,
    lng: 128.2980,
    kategoriKonstruksi: 'Pembangunan JTM Baru (Perluasan)',
    statusProyek: 'Sedang Dikerjakan',
    progresPersen: 50,
    targetSelesai: '2026-03-30',
    tglMulai: '2026-02-01',
    anggaranRp: 240000000,
    pelaksanaVendor: 'PT Nusa Elektrik Maluku',
    pengawasPln: 'Ahmad Rivai (Team Leader Yantek)',
    volumeAset: '32 Tiang Beton 12m/350daN + 1.8 kms Kabel MVTC 3x70mm2',
    keterangan: 'Sebanyak 24 tiang sudah tertanam, penarikan kabel bundle MVTC mencapai 800 meter.',
    coordinatesPolyline: [
      [-3.6120, 128.2950],
      [-3.6080, 128.2980],
      [-3.6020, 128.3050]
  ...
  {
    id: 'kst-006',
    namaProyek: 'Penggantian Isolator Tumpu Keramik ke Polimer & Lightning Arrester',
    nomorSpk: 'SPK/REP/2026/011',
    penyulang: 'GALALA 1',
    section: 'OG ALLANG - UJUNG JARING',
    lokasi: 'Jalur Pesisir Pantai Galala - Hative Kecil',
    lat: -3.6600,
    lng: 128.2050,
    kategoriKonstruksi: 'Penggantian Isolator Flashover / Arrester',
    statusProyek: 'Selesai Beroperasi',
    progresPersen: 100,
    ...
    pengawasPln: 'Samsul Bahri (Supervisor Teknik)',
    volumeAset: '36 Set Line Post Polymer 24kV + 6 Set Metal Oxide Arrester 21kV 10kA',
    keterangan: 'Penggantian menyeluruh isolator keramik yang rentan terkena uap garam laut di tepi teluk.'
  }
];
